...
CART_DOUBLE_PENDULUM_CFG = ArticulationCfg(
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        pos=(5.0, 0.0, 2.0), joint_pos={"SlidertoCart": 0.0, "CarttoPole": math.pi, "Pole1toPole2": 0.0}
    ),
    actuators={
...
class ActionsCfg:
    ...
    joint_effort = mdp.JointEffortActionCfg(asset_name="robot", joint_names=["SlidertoCart"], scale=15.0)
...
class RewardsCfg:
    ...
    joint_pos = RewTerm(func=mdp.joint_pos_target_l2,weight = -20.0 ,params={"asset_cfg": SceneEntityCfg("robot",joint_names = ["CarttoPole"]),"target" : 0.0})

    joint_pos2 = RewTerm(func=mdp.joint_pos_target_l2,weight = -20.0 ,params={"asset_cfg": SceneEntityCfg("robot",joint_names = ["Pole1toPole2"]),"target" : 0.0})
...
@configclass
class Swingup_DoubleCartpoleEnvCfg(ManagerBasedRLEnvCfg):
